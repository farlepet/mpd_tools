...
TO_DEVICE     = $(CURDIR)/bin/mpd_to_device

all: $(DUP_FIND) $(DISP_PLAYLIST) $(COPY_PL_FILES) $(CREATE_M3U8) $(CREATE_CSV) $(TO_DEVICE)
...
$(TO_DEVICE):
	@make -C $(CURDIR)/mpd_to_device EXEC=$(TO_DEVICE)

clean:
	@echo -e "\033[33m  \033[1mRemoving executables\033[0m"
	@rm -f $(DUP_FIND) $(DISP_PLAYLIST) $(COPY_PL_FILES) $(CREATE_M3U8) $(CREATE_CSV) $(TO_DEVICE)
	...
	@make -C $(CURDIR)/mpd_to_device clean
